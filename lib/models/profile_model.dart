class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) {
    ...
    final dob = DateTime.parse(json['dob']['date']);
    final registered = DateTime.parse(json['registered']['date']);
    final imageUrl = json['picture']['medium'];
    ...
    return User(
      ...
      email: json['email'],
      dob: dob,
      daysSinceRegistered: DateTime.now().difference(registered).inDays,
      imageUrl: imageUrl,
    );
  }
}
